...
public class DateUtil extends org.apache.commons.lang3.time.DateUtils {
     ...
     * @return
     */
    public static Date getCurMonthFirstDay(Date curDate){
     ...
     * @return
     */
    public static Date getPreMonthFirstDay(Date curDate){
        Calendar cal = Calendar.getInstance();
        cal.setTime(curDate);
     ...
     * @return
     */
    public static Date getPreMonthLastDay(Date curDate){
        Calendar cal = Calendar.getInstance();
        cal.setTime(curDate);
        cal.add(Calendar.MONTH, -1);
