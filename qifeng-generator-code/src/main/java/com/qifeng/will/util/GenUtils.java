...
public class GenUtils {
     ...
     * @return
     */
    public static List<String> getTemplates_1() {
        List<String> templates = new ArrayList<String>();
        templates.add("templates/generator_1/entity.java.vm");
        templates.add("templates/generator_1/Dao.java.vm");
        templates.add("templates/generator_1/Mapper.xml.vm");
        templates.add("templates/generator_1/Service.java.vm");
        templates.add("templates/generator_1/ServiceImpl.java.vm");
        templates.add("templates/generator_1/Controller.java.vm");
        return templates;
    }
    ...
    public static void generatorCode(Map<String, String> table,
        ...
        for (Map<String, String> column : columns) {
            ...
            // 是否是decimal类型
            if ("decimal".equals(columnDO.getDataType())) {
                hasBigDecimal=true;
            }
        ...
        // 获取模板列表
        List<String> templates = getTemplates_1();
