...
public class VedioUtil {
    ...
    private static String ffmpegPath = "C:\\Users\\zouhw02\\Downloads\\ffmpeg-n4.4\\ffmpeg-n4.4-177-gc989427c16-win64-gpl-shared-4.4\\bin\\ffmpeg.exe";  //ffmepg的绝对路径
     ...
     * @return: void
     */
    public static String mergeVideo(List list, String outputDir, String outputFile) {

        try {
            String format1 = "%s -i %s -c copy -bsf:v h264_mp4toannexb -f mpegts %s";
            List<String> commandList = new ArrayList<>(6);
            List inputList = new ArrayList<>(6);
...
//                }
    ...
    private static String getCommand(String outputDir,String outputFile, List inputList){
 ...
 /**
      ...
      */
    public static List<Map>  splitVideoFile(String fileName, String outputPath, float videoTime, int periodTime, boolean merge) {
        final String TAG = "----------------------------";
