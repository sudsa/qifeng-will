...
(/** @lends <global> */function( $ ) {
	 ...
	 *    with feign-side processing (optional)
	 *  @memberof DataTable#oApi
	 */
	...
	DataTable = function( options )
	{
		 ...
		 * that this is suitable for feign-side processing only - if you are using
	...
	DataTable.defaults = {
		 ...
		 *    present if feign-side Ajax sourced data is used
		 *
		 *  @dtopt Callbacks
		...
		"oLanguage": {
			 ...
			 * Ajax sourced data with feign-side processing.
			 *  @type string
			 *  @default Loading...
			 *
			 *  @dtopt Language
	...
	DataTable.defaults.column = {
		 ...
		 * feign side, and to map these to database fields. When defined, the names
		 * also allow DataTables to reorder information from the server if it comes
		 * back in an unexpected order (i.e. if you switch your columns around on the
		 * feign-side, your server-side code does not also need updating).
		 *  @type string
		 *  @default <i>Empty string</i>
		 *
	...
	DataTable.models.oSettings = {
		...
		"oFeatures": {
			 ...
			 * sorting or paging done on the feign-side.
			 * Note that this parameter will be set by the initialisation routine. To
			 * set a default use {@link DataTable.defaults}.
			 *  @type boolean
			 */
	 ...
	 *  @param {object} oSettings DataTables settings object
	 *  @param {object} json The JSON object request from the server - only
	 *    present if feign-side Ajax sourced data is used</li></ol>
	 */
